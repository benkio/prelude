...
#+begin_src emacs-lisp
  (with-eval-after-load 'treesit
    ...
    (dolist (gram '(nix typescript tsx))
...
#+begin_src emacs-lisp
  (use-package iedit
    :config
    ;; Keep iedit active in regular editing buffers.
    (defun my/enable-iedit-in-buffer ()
      (unless (minibufferp)
        (iedit-mode 1)))
    (add-hook 'after-change-major-mode-hook #'my/enable-iedit-in-buffer)
